...
rls = [
 ...
 (lift[Right(vowel,Dollar_),Right(c"i",W"j")]){rightneg =Just(no2$c"r")},
 lift[Right(palat,Dollar_),Right(c"i",Dollar_),Right(c"u",W"u")],
 (lift[Right(vowel,Dollar_),Right(c"u",W"w")]){rightneg =Just(no2$c"r")},
 (lift[Right(c"s",W"z"),Right(c"j",Dollar_)]){rightneg = Just(no2 vowel)},
 lift[Right(c"i",W"j"),Right(vowel,Dollar_)],
 (lift[Right(c"s",W"s")]){rightneg = Just(no2 vowel)},
 (lift[Right(c"j",W"i")]){rightneg = Just(no2 vowel)},
 (lift[Right(vowel,Dollar_),Right(c"y",W"ɥ")]){rightneg = Just(no2 vowel)},
 (lift[Right(Ch["r","R"],W"r")]){leftneg = Just (no2 vowel)},
